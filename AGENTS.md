...
- Each phase has to end in something the user can test by hand (not just tests). The user wants to iterate quickly and see results, not a perfect architecture with nothing running.
